...
if (!customElements.get("wattson-card")) {
  ...
  window.customCards.push({ type: "wattson-card", name: "Wattson", description: "Map and progressively label your breaker panel.", preview: false });
  /* eslint-disable no-console */
  console.info("%c PANEL-MAPPER-CARD %c " + CARD_VERSION + " ", "background:#1b2030;color:#fff;border-radius:3px 0 0 3px;padding:2px 4px", "background:#4a5bd8;color:#fff;border-radius:0 3px 3px 0;padding:2px 4px");
}
